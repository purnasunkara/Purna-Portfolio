  ...
  Basic: {
    ...
    scroller: function () {
      ...
      t.waypoint({
        ...
        offset: function () {
          return a.hasClass("header-horizontal")
            ...
            o.valid()
              ? ($.ajax({
                  ...
                  success: function (t) {
                    (a =
                      "SEND" === t
                        ? '<div class="alert alert-success">Done! Thank for your message - You will get you an answer as fast as possible!'
                        : '<div class="alert alert-danger">Ooops... It seems that we have a problem.'),
                      e.html(a),
                      e.show();
                  },
                }),
  ...
  Components: {
    ...
    videoPlayer: function () {
      ...
      e && e.YTPlayer(),
        trueMobile &&
          e.hasClass("bg-video") &&
          (e.prev(".bg-video-placeholder").show(), e.remove());
    },
    messenger: function () {
      $('[data-target="messenger"]').on("click", function () {
        ...
        return (
          e.hasClass("active")
            ? (t.find(".messenger-box-content").fadeOut(),
              e.fadeOut(300).removeClass("active"))
            : e
                .fadeIn(300, function () {
